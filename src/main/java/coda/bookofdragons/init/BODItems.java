...
public class BODItems {
    ...
    public static final RegistryObject<Item> TERRIBLE_TERROR_SPAWN_EGG = ITEMS.register("terrible_terror_spawn_egg", () -> new BODSpawnEggItem(BODEntities.TERRIBLE_TERROR, 0x000000, 0x000000, new Item.Properties().tab(BookOfDragons.GROUP)));
}
