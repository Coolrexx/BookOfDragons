...
public class BODItems {
    ...
    public static final RegistryObject<Item> EEL_SPAWN_EGG = ITEMS.register("eel_spawn_egg", () -> new ForgeSpawnEggItem(BODEntities.EEL, 0x222123, 0xc8bc15, new Item.Properties().tab(BookOfDragons.GROUP)));
